...
$$
La convergence presque surement entraine la convergence en probabilité. De plus sachant que la fonction $\sqrt{x}$ est continue sur son ensemble de définition.
